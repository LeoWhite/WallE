...
def drive_distance(bot, distance, speed=0.75):
    ...
    while primary_encoder.pulse_count < distance or secondary_encoder.pulse_count < distance:
        ...
        # Some debug
        print("Primary c:{} ({} mm)\tSecondary c:{} ({} mm) e:{} adjustment: {:.2f} speed:{:.2f}".format(
...
bot = Robot()
distance_to_drive = 500 # in mm - this is a meter
